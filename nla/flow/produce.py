...
def main():
    ...
    def flush_shard():
        ...
        write_shard(a.shard_dir, f"p{a.index}_{prog['shards']:07d}", payload, max_ready=None if (welford is not None or held is not None) else a.max_ready, stop_file=a.stop_file)
