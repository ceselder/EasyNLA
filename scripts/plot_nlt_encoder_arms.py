...
def main():
    ...
    ax2.set_ylabel("random pair's text: bits vs the blind prior"); ax2.set_title("Presence offset (acceptance condition A3): without a null term a random pair's text scores far BELOW the empty text;\nwith null-dm it scores a few bits above it — neither is within 3× the scoring noise", loc="left", fontsize=12.5)
