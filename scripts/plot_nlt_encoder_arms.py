...
def main():
    ...
    ax1.set_ylabel("content bits = bits(z) − bits(z_dm), all bands"); ax1.set_ylim(0, ax1.get_ylim()[1] * 1.75); ax1.legend(frameon=False, loc="upper center", fontsize=10, ncol=2)
