...
def main():
    ...
    fig.text(0.01, 0.002, "Redteam's data/claim_sensitivity_floor.json (exact bits, Heun 32, paired probes). Paraphrase bars near 0.5 = invariance (good); twin bars should be ≥ 0.65 for a critic that reads the claim. n per bar 170–450 pairs.", fontsize=9.5, color=INK2)
    fig.subplots_adjust(left=0.08, right=0.99, top=0.82, bottom=0.10, hspace=0.62)
