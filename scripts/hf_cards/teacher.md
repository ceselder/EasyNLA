...
`data/v0c_sft_rows/{v0c-tdv1,v0d-dos,v0-matched}` (rl, DECISIONS v1.33/v1.34): the exact SFT rows of V0c (teacher + dossier sentences), V0d (dossier-only sentences) and the matched V0 control (teacher-sonnet-v1 sentences of the SAME pair ids); counts in the .3way.json.
