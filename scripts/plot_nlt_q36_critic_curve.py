...
def main():
    ...
    DESC = {"v3": "activation-anchored gain contrast", "v3b": "anchored gain hinge, v1b recipe", "v3c": "margin-hinge anchor w 0.1 + guard, one pass over harvested pools", "v4": "plain one-pass critic on 16x harvested pools, no anchor", "v5": "pair cap: 4 of a position's 16 pairs per pass, no anchor"}
