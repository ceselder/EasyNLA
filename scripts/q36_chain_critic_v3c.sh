#!/usr/bin/env bash
# CRITIC v3c (orchestrator 08:15; only in a free slot AFTER critic v4 is running): v4's stage-1 config and pools (v1b recipe, no unconditional phase, one pass) + the plain margin HINGE anchor
