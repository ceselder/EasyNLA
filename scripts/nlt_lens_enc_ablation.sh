...
set -u
ARM=$1; STEPS=${2:-4000}; LR=${LR:-1e-4}; BATCH=${BATCH:-512}   # infra #109: 2e-4 was too hot for the cross-reads; their final round uses 1e-4
cd /home/celeste/nlt
